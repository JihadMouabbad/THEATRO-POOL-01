...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <h1 class="text-2xl font-bold text-pool-green mb-6">Create New Tournament</h1>
        ...
        <form action="{{ route('tournaments.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" 
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pool-green focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 class="font-semibold text-blue-800 mb-2">ℹ️ Tournament Information</h4>
