    ...
    <div class="bg-gradient-hero py-20 px-4 sm:px-6 lg:px-8 rounded-b-3xl shadow-2xl overflow-hidden relative">
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight">
                Welcome to <span class="text-pool-gold">Theatro Pool</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('tournaments.index') }}" 
                   class="group px-8 py-4 bg-white text-pool-green font-bold rounded-xl hover:bg-pool-gold hover:text-black transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center justify-center gap-2">
...
<div class="mb-16">
    <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">
        Why Choose <span class="text-pool-green">Theatro Pool</span>?
    </h2>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover group">
            ...
            <h3 class="text-xl font-bold text-gray-800 mb-3">Tournament Management</h3>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover group">
            ...
            <h3 class="text-xl font-bold text-gray-800 mb-3">Player Statistics</h3>
            <p class="text-gray-600 leading-relaxed">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover group">
            <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-violet-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <span class="text-2xl">🎯</span>
            </div>
            <h3 class="text-xl font-bold text-gray-800 mb-3">Live Brackets</h3>
            <p class="text-gray-600 leading-relaxed">
...
<div class="mb-16">
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-3xl font-bold text-gray-800 flex items-center gap-3">
            <span class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">🔴</span>
            Live Tournaments
        </h2>
        <a href="{{ route('tournaments.index') }}" class="text-pool-green font-semibold hover:underline flex items-center gap-1">
            View All
           ...
           class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover group">
            ...
            <div class="p-6">
                <div class="flex items-start justify-between mb-3">
                    ...
                    <span class="px-3 py-1 bg-green-100 text-green-700 text-xs font-bold rounded-full animate-pulse">LIVE</span>
                </div>
                ...
                <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-100">
                    ...
                    <span class="text-sm font-semibold text-pool-green">{{ $tournament->matches->where('status', 'completed')->count() }} matches played</span>
                </div>
            </div>
        </a>
        @endforeach
...
<div class="mb-16">
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-3xl font-bold text-gray-800 flex items-center gap-3">
            <span class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">📅</span>
        ...
        <a href="{{ route('tournaments.show', $tournament) }}" 
           class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover group">
            ...
            <div class="p-6">
                <div class="flex items-start justify-between mb-3">
                    <h3 class="text-xl font-bold text-gray-800 group-hover:text-pool-green transition-colors">{{ $tournament->name }}</h3>
                    <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-full">UPCOMING</span>
                </div>
                <p class="text-gray-500 flex items-center gap-2 mb-2">
                ...
                <div class="mt-4">
                    <div class="flex justify-between text-sm mb-1">
                        ...
                        <span class="font-semibold">{{ $tournament->players->count() }}/{{ $tournament->max_players }}</span>
                    </div>
...
<div class="mb-16">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="grid grid-cols-1 md:grid-cols-5 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            ...
            <a href="{{ route('players.show', $player) }}" class="p-6 text-center hover:bg-gray-50 transition group">
                <div class="relative inline-block mb-3">
                    <div class="w-16 h-16 bg-gradient-to-br from-pool-green to-pool-felt rounded-full flex items-center justify-center text-white text-2xl font-bold group-hover:scale-110 transition-transform">
                ...
                <h4 class="font-bold text-gray-800 group-hover:text-pool-green transition-colors">{{ $player->display_name }}</h4>
                <div class="text-sm text-gray-500 mt-1">{{ $player->wins }}W - {{ $player->losses }}L</div>
                <div class="text-xs font-semibold text-pool-green mt-1">{{ $player->win_rate }}% Win Rate</div>
            </a>
            @endforeach
        </div>
    </div>
...
<!-- CTA Section -->
<div class="text-center bg-gradient-to-r from-pool-green via-pool-felt to-pool-green rounded-3xl p-12 text-white shadow-2xl">
    ...
    @auth
        <a href="{{ route('tournaments.create') }}" 
           class="inline-flex items-center gap-2 px-8 py-4 bg-white text-pool-green font-bold rounded-xl hover:bg-pool-gold hover:text-black transition-all duration-300 transform hover:scale-105 shadow-lg">
            <span class="text-xl">🏆</span>
            Create Tournament
        </a>
    @else
